...
<nav>
    ...
    <div class="cart-items">
        ...
        if (cartMap != null && products != null) {
            for (Product product : products) {
                ...
                double itemTotal = price * quantity + (price * gst * quantity / 100); // Calculate total including GST
        ...
        <div class="cart-item" id="data-product-id-<%= productId %>">
            ...
            <div class="cart-item-details">
                ...
                <p>
                    ...
                    Quantity: <%= quantity %>
                    <br>
                    Item Total (incl. GST): Rs. <%= String.format("%.2f", itemTotal) %>
                </p>
            </div>
    ...
    <div class="total-amount">
        Total Amount (incl. GST): Rs. <%= String.format("%.2f", totalAmount) %>
        <p style="font-size: 12px;">(Inclusive of all applicable taxes)</p>
    </div>
