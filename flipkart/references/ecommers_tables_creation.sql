...
-- New tables
CREATE TABLE OrderValueWithShippingCharges (
...
CREATE TABLE ServiceableRegions (
    srrg_id INT PRIMARY KEY,
    srrg_name VARCHAR(100),
    srrg_pinfrom INT,
    srrg_pinto INT
);

CREATE TABLE ProductCategoryWiseServiceableRegions (
    productcategaory_id INT,
    srrg_id INT,
    PRIMARY KEY (productcategaory_id, srrg_id)
);
